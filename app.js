...
// this refers to the global window variable 
// 3. Explain why "this" is different when an arrow function is used.
// this is different when the arrow function is used because it references the global window variable and cannot reference the object using this. It is trying to reference the "this" of the function which doesn't exist and so it goes one step larger to check the scope.
